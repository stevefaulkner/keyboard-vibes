# Keyboard Operability JS Pro Responsive v0.9
...
- Restores the helper functions accidentally dropped from v0.8.
...
The report converts axe-core rule IDs into more useful information:
...
This makes findings like `landmark-one-main` and `region` easier to understand in QA reports.
